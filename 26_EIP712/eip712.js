import { ethers } from "ethers";
 //V5版本： import { verifyTypedData } from '@ethersproject/wallet';


// 利用Alchemy的rpc节点连接以太坊网络
// 准备 alchemy API 可以参考https://github.com/AmazingAng/WTFSolidity/blob/main/Topics/Tools/TOOL04_Alchemy/readme.md 
const ALCHEMY_GOERLI_URL = 'https://eth-goerli.alchemyapi.io/v2/GlaeWuylnNM3uuOo-SAwJxuwTdqHaY5l';
// V5版本：const provider = new ethers.providers.JsonRpcProvider(ALCHEMY_GOERLI_URL);
...
const main = async () => {
    ...
    // EIP712 签名
    //V5版本： const signature = await wallet._signTypedData(domain, types, message);
    const signature = await wallet.signTypedData(domain, types, message);
    console.log("Signature:", signature);
    // 验证 EIP712 签名，从签名和消息复原出 signer 地址
    //V5版本： let eip712Signer = verifyTypedData(domain, types, message, signature)
